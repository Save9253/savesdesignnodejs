  ...
  return (
    <main id="content">
      <Head>
        ...
        <section>
          <svg onMouseEnter={()=>{expr(yesEx);setReyeOp(false)}} onMouseLeave={()=>{expr(normEx);setReyeOp(true)}} role="img" aria-label="Save" style={{height:200}} viewBox="0 0 149 203" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g fill="var(--md50)">
              <path d={LeyeSh}/>
              <path d={Rshadow}/>
              <path d={Lshadow}/>
